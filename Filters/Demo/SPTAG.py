...
class AnnIndex(object):
    ...
    def BuildWithFilters(self, p_data, p_filters, p_vectorNum, p_filterNum, p_filtersDimension):
        return _SPTAG.AnnIndex_BuildWithFilters(self, p_data, p_filters, p_vectorNum, p_filterNum, p_filtersDimension)
    ...
    def SearchWithFilters(self, p_data, p_filters, p_filterNum, p_filtersDimension, p_resultNum):
        return _SPTAG.AnnIndex_SearchWithFilters(self, p_data, p_filters, p_filterNum, p_filtersDimension, p_resultNum)

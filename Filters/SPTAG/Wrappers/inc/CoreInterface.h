...
public:
    ...
    bool BuildWithFilters(ByteArray p_data, ByteArray p_filters, SizeType p_vectorNum, SizeType p_filterNum, DimensionType p_filtersDimension);
    ...
    std::shared_ptr<QueryResult> SearchWithFilters(ByteArray p_data, ByteArray p_filters, SizeType p_filterNum, DimensionType p_filtersDimension, int p_resultNum);

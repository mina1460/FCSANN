...
public:
    ...
    virtual void NormalizeFilters(int p_threads) = 0;

    virtual SizeType FiltersCount() const = 0;
};
...
public:
    ...
    virtual void* GetFilters(SizeType p_vectorID) const;

    virtual void* GetFiltersData() const;
    
    virtual DimensionType FiltersDimension() const;
    
    virtual SizeType FiltersCount() const;

    virtual void NormalizeFilters (int p_threads);
...
private:
    ...
    DimensionType m_filtersDim;

    SizeType m_filtersCount;

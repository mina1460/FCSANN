...
namespace SPTAG
{
    namespace COMMON
    {
        ...
        public:
            ...
            void setFilterdataSet(std::shared_ptr<FilterdataSet> filterdataSet)
            {
                m_filterdataSet = filterdataSet;
            }
            SPTAG::ByteArray GetFilterdataSet(SizeType p_vectorID) const { 
                return m_filterdataSet->GetFilterdata(p_vectorID);
            }
            std::shared_ptr<FilterdataSet> GetFilterdataSet() const { return m_filterdataSet; }

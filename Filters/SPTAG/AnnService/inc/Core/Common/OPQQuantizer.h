...
namespace SPTAG
{
    namespace COMMON
    {
        ...
        protected:
            ...
            const std::function<float(const OPQMatrixType*, const OPQMatrixType*, DimensionType)> m_fdot = NULL; 
            // SPTAG::COMMON::DistanceCalcSelector<OPQMatrixType>(SPTAG::DistCalcMethod::Cosine);  //TODO uncomment

...
#undef DefineKDTParameter
                ...
                m_fComputeDistance = std::function<float(const T* , const T* , DimensionType ,SizeType , const T* , const T* , DimensionType )>(COMMON::DistanceCalcSelector<T>(m_iDistCalcMethod));
            ...
            inline float AccurateDistance(const void* pX, const void* pY) const {
                ...
                float xy = m_iBaseSquare - m_fComputeDistance((T*)NULL,(T*) NULL, (SPTAG::DimensionType)1,(SPTAG::SizeType)1,(const T*)pX, (const T*)pY, m_pSamples.C());
            ...
            ErrorCode SearchIndexWFilters(QueryResult &p_query, bool p_searchDeleted = false)const {
                 printf("entered the KDT search function\n");

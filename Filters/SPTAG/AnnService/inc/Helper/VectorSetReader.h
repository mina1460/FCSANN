...
public:
    ...
    virtual std::shared_ptr<FilterdataSet> GetFilterdataSet() const = 0;
    ...
    virtual ErrorCode LoadFilterVectorFile(const std::string& p_filePath) = 0;

    virtual std::shared_ptr<VectorSet> GetFilterVectorSet(SizeType start = 0, SizeType end = -1) const = 0;

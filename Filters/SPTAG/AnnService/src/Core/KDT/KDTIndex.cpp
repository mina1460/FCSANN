...
#define Search(CheckDeleted) \
        ...
        while (!p_space.m_NGQueue.empty()) { \
            ...
            for (DimensionType i = 0; i < m_pGraph.m_iNeighborhoodSize; i++) { \
                ...
                float distance2leaf = m_fComputeDistance((T*)NULL,(T*) NULL, (SPTAG::DimensionType)1,(SPTAG::SizeType)1,p_query.GetQuantizedTarget(), (m_pSamples)[nn_index], GetFeatureDim()); \

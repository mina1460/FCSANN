...
int main(){
    const int data_dim = 5; //3
    const int filter_dim =2; //1
    const int filters_num = 3; //5
    const int data_num = 1; //10
    ...
    float data[data_num][data_dim] = {{56,85,19,13,49}};
    float data_filters [data_num][filters_num][filter_dim] = {{{0,3}, {4,3}, {5,3}}};
    float query_point[data_dim] = {9,15,53,20,63};
    float query_point_filter[filters_num][filter_dim] = {{1,3}, {4,3}, {5,0}};

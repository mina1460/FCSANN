...
namespace SPTAG
{
    ...
    public:
        ...
        virtual ErrorCode SearchIndex(std::vector<QueryResult> &queries, bool p_searchDeleted = false) const;
        ...
        virtual ErrorCode ThreadedSelectHeads(std::vector<std::vector<SPTAG::QueryResult>> &queries, int C_num_threads, int P_num_threads) const = 0;
